...
const (
	...
	NODE_START_SIG          = 0
	NODE_END_SIG            = 65
	NODE_START_MSGHASH      = 65
	NODE_END_MSGHASH        = 97
	NODE_START_PAYER        = 97
	NODE_END_PAYER          = 129
	NODE_START_NODETYPE     = 129
	NODE_END_NODETYPE       = 130
	NODE_START_MINREP       = 130
	NODE_END_MINREP         = 131
	NODE_START_MAXREP       = 131
	NODE_END_MAXREP         = 132
	NODE_START_BIRTHTS      = 132
	NODE_END_BIRTHTS        = 140
	NODE_START_LASTUPDATETS = 140
	NODE_END_LASTUPDATETS   = 148
	NODE_START_ENCRYPTED    = 148
	NODE_END_ENCRYPTED      = 149
	NODE_START_VERSION      = 149
	NODE_END_VERSION        = 157
	NODE_START_RENEW        = 157
	NODE_END_RENEW          = 158
	NODE_START_RENEW        = 157
	NODE_END_RENEW          = 158
	NODE_START_KEY          = 158
	NODE_END_KEY            = 190
	NODE_START_OWNER        = 190
	NODE_END_OWNER          = 222
	NODE_START_DB           = 222
	NODE_END_DB             = 254
	NODE_START_TABLE        = 254
	NODE_END_TABLE          = 286
	NODE_START_SEED         = 286
	NODE_END_SEED           = 318
	NODE_START_ITERATOR     = 318
	NODE_END_ITERATOR       = 414
	NODE_START_CHUNKVAL     = 512
